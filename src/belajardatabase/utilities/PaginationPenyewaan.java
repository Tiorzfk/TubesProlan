 ...
 * @author ASEP
 */
public class PaginationPenyewaan {
     ...
     *
     */
    public PaginationPenyewaan isSQLChanged = this;
    public PaginationPenyewaanGUIComponent GUIComponent = null;
    
    public PaginationPenyewaan() {
        GUIComponent = new PaginationPenyewaanGUIComponent(this);
    }
