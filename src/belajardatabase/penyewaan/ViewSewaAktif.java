 ...
 * @author ASEP
 */
public class ViewSewaAktif extends javax.swing.JPanel {
     ...
     */
    public ViewSewaAktif(javax.swing.JFrame frame) {
        this.frame = frame;
    ...
    private void initComponents() {
        ...
        tutupPenyewaanButton.setText("Tutup Penyewaan");
        tutupPenyewaanButton.setEnabled(false);
        tutupPenyewaanButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tutupPenyewaanButtonActionPerformed(evt);
            }
        });
    ...
    private void tutupPenyewaanButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tutupPenyewaanButtonActionPerformed
        int row = viewTable.getSelectedRow();
        int idSewa = Integer.valueOf(viewTable.getValueAt(row, 0).toString());
        
        javax.swing.JPanel en = new belajardatabase.penyewaan.Pengembalian(frame, idSewa);
    ...
    private javax.swing.JButton tutupPenyewaanButton;
