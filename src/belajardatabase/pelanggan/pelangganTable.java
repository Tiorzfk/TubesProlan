...
public class pelangganTable extends javax.swing.JFrame {
    ...
    private String getPencarianSQLQuery() {
        ...
        return "(" +
                    "noKTP like " + quotateWithPercent(cari) + " OR " +
                    "nama     like " + quotateWithPercent(cari) +
                ")";
    }
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(630, 616));
        ...
        dataDetailPanel.setBorder(javax.swing.BorderFactory.createTitledBorder("Detail Informasi"));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addComponent(viewScrollPane, javax.swing.GroupLayout.Alignment.TRAILING)
        );
        jPanel1Layout.setVerticalGroup(
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(viewScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 197, Short.MAX_VALUE)
        );
        ...
        btn_hapus.setName("btn_hapus"); // NOI18N
        ...
        keluarMenu.setText("File");
        jMenuBar1.add(keluarMenu);

        pelangganMenu.setText("Edit");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(dataDetailPanel, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 598, Short.MAX_VALUE))
                        .addContainerGap())
                    .addGroup(layout.createSequentialGroup()
    ...
    private void viewTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_viewTableMouseClicked
        ...
        if (row != -1) {
            PelangganTableModel model = (PelangganTableModel) viewTable.getModel();
    ...
    private void btn_hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_hapusActionPerformed
         try {
                ...
                mdbc.init();
                Connection conn =mdbc.getMyConnection();
                String noKTP = field_no_ktp.getText();
                String query = "DELETE FROM pelanggan WHERE noKTP="+quotate(noKTP);
                pst = conn.prepareStatement(query);
                ...
                System.out.println("Error inside `hapus` : "
                    + e.getMessage());
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pelangganTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pelangganTable().setVisible(true);
            }
        });
    }
